    ...
    return (
      <div>
        ...
        <BackdropCard>
          ...
          <hr/>
          <Answer>{"Have a question or found a bug? Let us know by emailing cetacea@mit.edu with details."}</Answer>
        </BackdropCard>
      </div>
    )
  }
