...
public class JournalsRecord extends UpdatableRecordImpl<JournalsRecord> implements Record4<Integer, String, Timestamp, Integer> {
     ...
     */
    @Override
    public JournalsRecord value3(Timestamp value) {
        setTimestamp(value);
        return this;
    }
     ...
     */
    @Override
    public JournalsRecord values(Integer value1, String value2, Timestamp value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JournalsRecord(Integer id, String entry, Timestamp timestamp, Integer userId) {
        super(Journals.JOURNALS);
